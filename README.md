...
Full-stack developer specializing in backend architecture and distributed systems.<br/>
I build scalable, maintainable software with Java & Node.js on the backend<br/>
and React / Next.js on the frontend, deployed with Docker & Kubernetes.<br/>
Passionate about clean code, solid design patterns, and shipping things that last.
...
![Trophies](https://gh-trophy.cdnsoft.net/?username=n1b3lung0&theme=gitdimmed&column=6&no-frame=true&margin-w=6)
